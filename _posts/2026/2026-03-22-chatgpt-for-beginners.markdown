...
<center>
    <img src='/i/2026/chatgpt-for-beginners-header.png' alt="Beginner's guide to ChatGPT and AI tools">
</center>

<br />
This is the second post in my [AI for Life Design series](/tag/ai-for-life-design.html) - a beginner-friendly guide to using AI to improve your everyday life. If you missed the first post, I'd recommend [starting there](/posts/ai-for-life-design.html) to get the full picture of what the series is about. In case you're wondering, I've been using AI to assist me writing this series...it's only right to practise what I preach!
...
**Gemini**
Google's AI tool. If you already use Gmail, Google Docs, or Google Drive, Gemini is increasingly woven into those tools - which means you may already have access to it without realising. It's a solid choice and free to use.

**Microsoft Copilot**
Built into Windows 11 and the Edge browser, Copilot is Microsoft's AI offering (powered by the same technology behind ChatGPT). If you're a Windows user, you may already have a Copilot button sitting in your taskbar.
...
1. Open your web browser and go to **[chatgpt.com](https://chatgpt.com){:target="_blank" rel="noreferrer noopener"}**
2. Click **Sign up**
...
If you're not already signed up to my newsletter, pop your details in below and I'll let you know the moment it's live.

<br />
<i>Have you just set up ChatGPT for the first time? Or have you been using it a while - what's been your most useful moment with it? I'd love to hear in the comments below...</i>
<br />
